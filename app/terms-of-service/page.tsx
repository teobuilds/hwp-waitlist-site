    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-10 md:pt-24 md:pb-16 px-4 md:px-6 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-6 md:gap-8 text-[13px] md:text-[15px]" style={body}>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>4. Orders, Billing &amp; Fraud Prevention</h2>
            <ul className="list-disc pl-5 flex flex-col gap-1">
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>5. Shipping</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>6. Returns and Refunds</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>7. Fitness &amp; Training Content Disclaimer</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>8. User Submissions</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>9. Third-Party Links</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>10. Intellectual Property</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>11. Prohibited Uses</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>12. Disclaimer of Warranties</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>13. Limitation of Liability</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>14. Indemnification</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>15. Termination</h2>
            <p>We may terminate or restrict your access to the Site at any time, without notice, if we believe you&apos;ve violated these Terms. Obligations that by their nature should survive termination (e.g., Sections 10, 13, 14) will survive.</p>
          </div>

          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>16. Severability &amp; Entire Agreement</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>17. Governing Law</h2>
          ...
          <div>
            <h2 className="mb-1.5 text-[14px] md:text-[17px]" style={h2}>18. Contact Us</h2>
