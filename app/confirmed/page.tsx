...
export default function ConfirmedPage() {
  return (
    <main className="h-[100dvh] overflow-hidden md:h-auto md:min-h-screen bg-white">
      ...
      <section className="h-full md:h-screen flex flex-col items-center justify-center text-center px-6 gap-2 md:gap-4">
        <h1 className="text-[24px] md:text-[40px]" style={{ color: '#7956B9', fontWeight: 700, letterSpacing: '-0.04em', lineHeight: 1 }}>
          You&apos;re in!
        </h1>
        <p className="text-[17px] md:text-[35px]" style={{ color: '#AF94E0', fontWeight: 700, letterSpacing: '-0.04em', lineHeight: 1.1 }}>
          You&apos;ll be the first to know when we drop.
        </p>

        <div>
          <Image src="/images/screen-home.png" alt="Hoop With Prezence App" width={200} height={400} className="drop-shadow-xl w-[110px] md:w-[200px] h-auto" />
        </div>
        ...
        <div className="flex gap-6 items-center">
          <a href="https://tiktok.com/@hoopwithprezence" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
            <Image src="/images/tiktok.png" alt="TikTok" width={52} height={52} className="w-[36px] h-[36px] md:w-[52px] md:h-[52px] object-contain" />
          </a>
          <a href="https://instagram.com/hoopwithprezence" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
            <Image src="/images/instagram.png" alt="Instagram" width={56} height={56} className="w-[40px] h-[40px] md:w-[56px] md:h-[56px] object-contain" />
          </a>
        </div>
      </section>
    </main>
